...
class HuggingFaceVisionService implements VisionServiceInterface {
  @override
  Future<VisionResult> analyzeImage({
    ...
    throw VisionException(
      'HuggingFace support coming soon. Follow updates at pub.dev/packages/smart_vision_flutter',
    );
  }
}
